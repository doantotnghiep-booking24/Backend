...
Router.post('/CreateTour', AuthUser(["Admin", "Staff"]), uploadCloud.array('Image_Tour'), Tour_Controller.Create_Tour)
Router.post('/Update/:id',AuthUser(["Admin", "Staff"]), uploadCloud.array('Image_Tour'), Tour_Controller.UpdateTour) // Vd : V1/Tours/Update/669a3bad03ec7167578570d8
Router.post('/Delete/:id', AuthUser(["Admin", "Staff"]), Tour_Controller.DeleteTour) // Vd : V1/Tours/Delete/669a3bad03ec7167578570d8
Router.post('/Restore/:id', AuthUser(["Admin", "Staff"]), Tour_Controller.DeleteTour) // Vd : V1/Tours/Delete/669a3bad03ec7167578570d8
Router.post('/Remove/:id', AuthUser(["Admin", "Staff"]), Tour_Controller.RemoveTour) // Vd : V1/Tours/Delete/669a3bad03ec7167578570d8
