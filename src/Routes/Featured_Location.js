...
Router.post('/CreateFeatured_Location', Featured_Location_Controller.CreateFeatured_Location) // http://localhost:3001/V2/Featured_Location/CreateFeatured_Location
Router.post('/UpdateFeatured_Location/:id', Featured_Location_Controller.UpdateFeatured_Location) // http://localhost:3001/V2/Featured_Location/UpdateFeatured_Location/66a46a2852a8d1dbe7a70291
