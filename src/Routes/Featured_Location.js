...
Router.get('/GetFeatured_Location', AuthUser(['Admin', 'User']), Featured_Location_Controller.GetAllFeatured_Location) // http://localhost:3001/V2/Featured_Location/GetFeatured_Location
