...
class Schedule_Travel {
    ...
    CreateSchedule_Travel(req, res, next) {
        const { Name_Schedule, Departure_Time, Location, means_of_transport } = req.body
        Connection.connect().then(async (db) => {
            try {
                const Create = new Schedule(undefined, Name_Schedule, Departure_Time, Location, means_of_transport)
    ...
    UpdateSchedule_Travel(req, res, next) {
        ...
        Connection.connect().then(async (db) => {
            try {
                const Update = new Schedule(undefined, Name_Schedule, Departure_Time, Location, means_of_transport)
